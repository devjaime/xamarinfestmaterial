...
namespace GPSImageTag.Core.Services
{
    ...
    public class AzureService
    {
        ...
        public async Task Initialize()
        {
            ...
            var appUrl = "Mobile App Service URL goes here";
        ...
        public async Task<Photo> AddPhoto(MemoryStream image, string name, string desc)
        {
            await Initialize();

            var photo = new Photo();

            var storageService = DependencyService.Get<IAzureStorageService>();

            var imageUri= await storageService.UploadImage(image, name);
